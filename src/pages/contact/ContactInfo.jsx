        ...
        <div className="rn-contact-top-area rn-section-gapTop bg_color--5">
            <div className="container">
                <div className="row g-5">
                    <div className="col-lg-12"  data-sal-delay={150} data-sal-duration={800}>
                        <div className="section-title mb--30 text-center">
                            <h2 className="title">Quick Contact Address</h2>
                            <p className="description">There are many variations of passages of Lorem Ipsum available, <br /> but
                                the majority have suffered alteration.</p>
                        </div>
                    </div>
                </div>
                <div className="row g-5">
                    <div className="col-lg-4 col-md-6 col-sm-6 col-12"  data-sal-delay={150} data-sal-duration={800}>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-6 col-12"  data-sal-delay={200} data-sal-duration={800}>
                        <div className="rn-address">
                            <div className="icon">
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-6 col-12"  data-sal-delay={250} data-sal-duration={800}>
                        <div className="rn-address">
                            <div className="icon">
