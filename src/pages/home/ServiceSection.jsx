                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12 mb--50">
                            <h3 className="title" data-sal-delay={150} data-sal-duration={800}>Create and sell your NFTs</h3>
                        </div>
                    </div>
                    <div className="row g-5">
                        {/* start single service */}
                        <div className="col-xxl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div data-sal-delay={150} data-sal-duration={800} className="rn-service-one color-shape-7">
                                <div className="inner">
                                    <div className="icon">
                        ...
                        {/* start single service */}
                        <div className="col-xxl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div data-sal-delay={200} data-sal-duration={800} className="rn-service-one color-shape-1">
                                <div className="inner">
                                    <div className="icon">
                        ...
                        {/* start single service */}
                        <div className="col-xxl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div data-sal-delay={250} data-sal-duration={800} className="rn-service-one color-shape-5">
                                <div className="inner">
                                    <div className="icon">
                        ...
                        {/* start single service */}
                        <div className="col-xxl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div data-sal-delay={300} data-sal-duration={800} className="rn-service-one color-shape-6">
                                <div className="inner">
                                    <div className="icon">
