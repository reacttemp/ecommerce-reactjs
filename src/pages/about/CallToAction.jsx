                            ...
                            <div className="row">
                                <div className="col-lg-12">
                                    <div className="call-to-action-wrapper">
                                        <h3  data-sal-duration={800} data-sal-delay={150}>Discover
                                            rare digital art <br />
                                            and collect NFTs</h3>
                                        <p  data-sal-duration={800} data-sal-delay={150}>The NFTs is a one-trick pony that climbed the recent years. The growth of NFTs is
                                            tremendous, and according to Pymnts.com, the total sales volume </p>
                                        <div className="callto-action-btn-wrapper"  data-sal-duration={800} data-sal-delay={150}>
